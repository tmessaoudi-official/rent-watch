...
{
    /** Matches `config/criteria.json`'s shipped `digest_hour` and Q34's own wording. */
     ...
     * low-priority rollup, which is the benign direction, while touching `src/php/Store/**` would
