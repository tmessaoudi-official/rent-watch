...
use Scout\Vehicle\VehicleCriteria;
use Scout\Vehicle\VehicleCriteriaLoader;
use Scout\Vehicle\VehicleEmailSource;
use Scout\Vehicle\VehicleFormatter;
use Scout\Vehicle\VehicleOutcome;
use Scout\Vehicle\VehiclePipeline;
use Scout\Vehicle\VehicleScorer;
use Scout\Vehicle\VehicleSource;
 ...
 */
final readonly class VehicleScout
{
    ...
    private function report(\Scout\Vehicle\VehicleRunResult $r, bool $seed, bool $verbose): void
    {
