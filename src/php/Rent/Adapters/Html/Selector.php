...
namespace Scout\Rent\Adapters\Html;
 ...
 * {@see \Scout\Rent\Adapters\Payload::at()}. So HTML semantics belong adapter-side too, and the
...
final readonly class Selector
{
     ...
     * {@see \Scout\Rent\Adapters\HtmlSource}, where it belongs, because that one is indistinguishable
