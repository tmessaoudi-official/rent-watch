 ...
 * against `tests/fixtures/rent/tenure/corpus.json` with no adapter, no HTTP and no config loader in the
...
{
    /**
     * @param string       $name          matches the key in `config/rent/sources.json`
