...
final class CdcHabitatFixtureTest extends TestCase
{
    ...
    {
        return (string) file_get_contents(self::ROOT . '/tests/fixtures/rent/cdc_habitat/search.html');
    }

    private function definition(): SourceDefinition
    {
        return ConfigLoader::loadSources(self::ROOT . '/config/rent/sources.json')['cdc_habitat'];
    }
