 ...
 */
final class ScoutDigestFloorTest extends TestCase
{
    ...
    public function testAWindowAlreadyServedTodayDoesNotFireAgain(): void
    {
        ...
        file_put_contents($root . '/state/digest.txt', "2026-08-23T08:05:00+02:00\n");
    ...
    public function testTheInLoopFloorRunsAndIsNotJustTheStartupOneAgain(): void
    {
        ...
        // `use` list and all.
        $root = $this->tempRoot();
        mkdir($root . '/state/digest.txt', 0o775, true);
