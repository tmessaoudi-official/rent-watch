...
final class PipelineRunTest extends TestCase
{
    ...
    public function testTheSchemaVersionIsNine(): void
    {
        ...
        self::assertSame(9, Store::SCHEMA_VERSION);
        self::assertSame(9, $this->store()->schemaVersion());
    }
    ...
    public function testAVersionOneDatabaseIsUpgradedThroughEveryLaterStep(): void
    {
        ...
        self::assertSame(9, $reopened->schemaVersion());
    ...
    public function testTheMigrationIsReRunnable(): void
    {
        ...
        self::assertSame(9, Store::open($path)->schemaVersion(), 'a re-run migration must not throw');
    }
