...
final class CitylogerFixtureTest extends TestCase
{
    ...
    private function definition(): SourceDefinition
    {
        ...
        $raw = json_decode((string) file_get_contents(self::ROOT . '/config/sources.json'), true, 512, JSON_THROW_ON_ERROR);
    ...
    {
        $committed = ConfigLoader::loadSources(self::ROOT . '/config/sources.json')['cityloger'];
    ...
    {
        return (string) file_get_contents(self::ROOT . '/tests/fixtures/cityloger/' . $name);
    }
