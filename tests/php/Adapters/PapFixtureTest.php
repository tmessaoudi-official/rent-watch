 ...
 *
 * Everything here reads the SHIPPED `config/sources.json`, so a config edit that breaks extraction
...
final class PapFixtureTest extends TestCase
{
    ...
    public function testTheUnsubscribeLinkIsNotAPhantomSecondListing(): void
    {
        ...
        // silently satisfy it.
        $messages = glob(self::ROOT . '/tests/fixtures/pap/*.eml') ?: [];
    ...
    public function testTheAlertSenderIsScopedAndNotThePortalsAccountAddress(): void
    {
        ...
        $params = ConfigLoader::loadSources(self::ROOT . '/config/sources.json')['pap']->params;
